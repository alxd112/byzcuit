...
for i in range(minSh, maxSh):
	...
	for line in f:
		...
		if count == 0:   clevtpsMean.append(x[0]*i) 
		elif count == 1: clevtpsStd.append(float(line[1]))
		elif count == 2: clevLatMean.append(x[0])
...
for i in range(minSh, maxSh):
	...
	for line in f:
		...
		if count == 0:   randtpsMean.append(x[0]*i) 
		elif count == 1: randtpsStd.append(float(line[1]))
		elif count == 2: randLatMean.append(x[0])
		elif count == 3: randLatStd.append(float(line[1]))
		count += 1
...
y = clevLatMean
asymetricerrorLatency = [clevLatStd, clevLatStd]
...
asymetricerrorStdRand = [randtpsStd, randtpsStd]
x = [elem+0.01 for elem in x]
y = randtpsMean
print(y)
...
y = LatMeanRand
asymetricerrorLatencyRand = [randLatStd, randLatStd]
