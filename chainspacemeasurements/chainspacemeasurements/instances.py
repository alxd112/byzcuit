...
class ChainspaceNetwork(object):
	...
	def _single_ssh_connect(self, instance):
		...
		k = paramiko.RSAKey.from_private_key_file('./ec2-keypair4.pem')
		client.connect(hostname=instance.public_ip_address, username='admin', pkey = k)#key_filename='./ec2-keypair3.pem')
